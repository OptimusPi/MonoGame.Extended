...
namespace MonoGame.Extended.Shapes
{
    ...
    public struct CircleF : IShapeF, IEquatable<CircleF>
    {
        ...
        {
            return Intersects(value.ToRectangleF());
        }

        /// <summary>
        /// Gets whether or not a specified <see cref="RectangleF"/> intersects with this <see cref="CircleF"/>.
        /// </summary>
        /// <param name="value">Other <see cref="RectangleF"/>.</param>
        /// <returns><c>true</c> if other <see cref="RectangleF"/> intersects with this <see cref="CircleF"/>; <c>false</c> otherwise.</returns>
